return {
  ...
  [ "getSlurryOutputFilledPercentage()" ] = {
    ...
    name = "getSlurryOutputFilledPercentage",
  },
  [ "getOwnerUUID()" ] = {
    name = "getOwnerUUID",
    returns = {
  ...
  [ "getSlurryInputFilledPercentage()" ] = {
    ...
    name = "getSlurryInputFilledPercentage",
  },
  [ "getSlurryInput()" ] = {
    returns = {
