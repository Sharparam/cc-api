return {
  ...
  [ "getRightInputFilledPercentage()" ] = {
    ...
    name = "getRightInputFilledPercentage",
  },
  ...
  [ "getLeftInputFilledPercentage()" ] = {
    ...
    name = "getLeftInputFilledPercentage",
  },
  [ "getLeftInputNeeded()" ] = {
    returns = {
      type = "Number (long)",
